...
lvl      log_level    = log3;      ///< Default log level, every message above it will not be displayed
...
bool     print_func   = true;       ///< Display logging function?
bool     print_source = false;      ///< Display logging place in source code?
bool     print_timer  = true;       ///< Display timer?
