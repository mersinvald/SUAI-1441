...
#define PRINT_FUNC()                ((mlog::print_func)                      ? mlog::Logger::resizeString(std::string(__FUNCTION__)    + ": ",16, ' ')             : "")
#define PRINT_SOURCE()              ((mlog::print_source)                    ? mlog::Logger::trimPath(std::string(__FILE__ ":") + std::to_string(__LINE__)) + " "  : "")
#define PRINT_TIMER()               ((mlog::print_timer)                     ? std::string("[") + mlog::Logger::getTimer()                                  + "] " : "")
